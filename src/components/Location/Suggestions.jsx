export function Suggestions({ city, state, country, id }) {
  return (
    <li className="" id={id} role="option">
      <div role="button" tabindex="-1" className="divbutton">
        <div className="align-last-search" data-testid="autocomplete-result">
          ...
          <div className="divcontent">
            <div className="title-country font-country">{city}</div>
            <div className="title-country font-people">{`${state}, ${country}`}</div>
          </div>
        </div>
      </div>
    </li>
